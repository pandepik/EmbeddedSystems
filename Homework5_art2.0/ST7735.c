...
void ST7735_MoveBall(int16_t x, int16_t y, int16_t n_x, int16_t n_y, uint16_t color){
		int i = 0;
		int16_t x_spd = n_x - x;
		int16_t y_spd = n_y - y;
...
void ST7735_MoveBallB(int16_t x, int16_t y, int16_t n_x, int16_t n_y, uint16_t color){
